...
@WebServlet(urlPatterns = "/ottRegistration",loadOnStartup = 1)
public class OTTRegistration extends GenericServlet {

    public OTTRegistration(){
        System.out.println("object created of OTTRegistration");
    }
    @Override
