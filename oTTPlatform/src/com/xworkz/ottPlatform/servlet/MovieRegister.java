...
@WebServlet(urlPatterns = "/movieRegister", loadOnStartup = 3)
public class MovieRegister extends GenericServlet {
    public MovieRegister(){
        System.out.println("object created of MovieRegister");
    }
    @Override
